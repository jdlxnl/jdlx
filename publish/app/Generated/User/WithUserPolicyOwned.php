...
trait WithUserPolicyOwned
{
    ...
    public function view(User $userWithRequest, User $user): bool
    {
        ...
        return $userWithRequest->hasPermissionTo("{$name}.user.view.{$user->id}");
    }
    ...
    {
        return $userWithRequest->hasPermissionTo("{$name}.user.create");
    }
    ...
    {
        $name = $this->getOwnerName($user);
        return $userWithRequest->hasPermissionTo("{$name}..user.restore.{$user->id}");
    }
    ...
    abstract public function getOwnerName(User $model);
}
